...
export default function LabReportsPage() {
  ...
  // ✅ Wrapped in useCallback to prevent infinite render loops when passed as a prop
  ...
  // ✅ Added fetchLabReports to the dependency array
  useEffect(() => {
    fetchLabReports();
  }, [fetchLabReports]);
          ...
          {selectedReport ? (
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  selectedReport.structured_data.testResults.length > 0 ? (
                    ...
                    <p className="text-sm text-muted-foreground">
                      No structured test results found. Raw text available below.
                    </p>
                  )}
                  {selectedReport.ai_analysis && (
                    <div className="mt-6 pt-6 border-t">
            ...
            <Card>
              <CardHeader>
                <CardTitle>Detailed Test Results</CardTitle>
                <CardDescription>
                  Select a report from the "Recent Reports" tab to view detailed analysis
                </CardDescription>
              </CardHeader>
            </Card>
          )}
